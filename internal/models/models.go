...
type Project struct {
	...
	VisualStyle            *string        `json:"visual_style,omitempty"`     // "cinematic watercolor", "photorealistic", etc.
...
type CreateProjectRequest struct {
	...
	VisualStyle           *string    `json:"visual_style,omitempty"`     // Default: "cinematic watercolor"
